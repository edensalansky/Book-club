...
public class NonBlockingConnectionHandler<T> implements ConnectionHandler<T> {
    ...
    private final MessageEncoderDecoderImp<T> encdec;
    ...
    public NonBlockingConnectionHandler(
            MessageEncoderDecoderImp<T> reader,
            StompMessagingProtocolImpl<T> protocol,
            SocketChannel chan,
            Reactor reactor, int connectionID,Connections connections1) {
        this.chan = chan;
        this.encdec = reader;
    ...
    public StompMessagingProtocol getProtocol(){
        return (StompMessagingProtocol)protocol;
    }
}
